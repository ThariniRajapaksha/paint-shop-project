...
namespace Tharini_Rajapaksha_KADSE202F_006
{
    public partial class Cleaners : Form
    {
        ...
        {
            string query = "SELECT Image, Stock, Name, Liters, Price FROM Cleaners";
        ...
        private void guna2Button2_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO OrderCleaners (Image, Name, QTY, Liters, Price, ClientUsername) VALUES (@Image, @Name, @QTY, @Liters, @Price, @ClientUsername)";
